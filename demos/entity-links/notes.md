...
- All six planted fund → holding → supplier chains were recovered. Jev’s answers alone produced 279 active sufficient edges and 2,038 directed two-step contagion paths (3,520 before shared auditors and litigation were left out as channels); labels are used only to grade the six planted chains.
