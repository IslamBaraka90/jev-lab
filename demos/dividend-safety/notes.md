...
- Jev was within 1.25 points of the simple payout-cover safety formula on 4 of 10 cover-complete issuers and matched its first pressure point on 2 of 10. That second count is mostly vocabulary: the cover check says "none" for seven of the ten and can never say share buybacks, and where it does name a pressure Jev matched 2 of 3. Both readings remain visible; the formula is a cross-check, not hidden truth.
