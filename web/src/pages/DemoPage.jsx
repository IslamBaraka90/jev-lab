...
/** One demo: its heading and neighbours, with the shared runtime underneath. */
        ...
        <>
          ...
          <div className="page-heading demo-heading">
            ...
            <div className="row demo-heading-actions">
              <Link to={`${pathname}?present=1`} className="button ghost" title="Presenter mode (p)">
                <Icon name="present" />
                Present
              </Link>
            </div>
